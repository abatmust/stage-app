        ...
        <div class="max-w-max mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg relative">
                ...
                <div class="flex items-center">
                    <x-dropdown-link :href="route('themes.create')" class="mb-2">
                    ...
                    <h2 class="uppercase text-lg text-center ml-3 font-extrabold">liste des thèmes de formation</h2>
                    ...
                    <tbody>
                        ...
                        <tr class="transition-colors bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-300 dark:hover:bg-gray-600">
                            ...
                            <td class="px-6 py-4 text-right flex">
                                <a href="{{route('themes.edit',['theme' => $theme->id])}}" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">
                                ...
                                <!-- delete -->
                                <form action="{{route('deleteTheme',['theme'=> $theme->id])}}" method="POST" onsubmit="dealSubmit(event)">
                                @method('DELETE')
                                @csrf
                                <button>
